...
@Component({
  templateUrl: './configuration.enviroment.component.html',
  styleUrls: ['./configuration.enviroment.component.scss']
})
export class ConfigurationEnviromentComponent implements OnInit {
  config: AppConfig;
  items: MenuItem[];
  uploadedFiles: any[] = [];
  selectedCity1: any;
