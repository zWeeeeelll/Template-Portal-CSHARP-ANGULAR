...
@Component({
  templateUrl: './configuration.produtcs.component.html',
  providers: [MessageService, ConfirmationService],
  styleUrls: ['./configuration.produtcs.component.scss']
})
export class ConfigurationProductsComponent implements OnInit {
  config: AppConfig;
